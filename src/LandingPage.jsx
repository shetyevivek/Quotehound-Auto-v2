...
<section className="py-20">
  ...
  <div className="container mx-auto px-4 lg:w-1/2 md:w-full text-center">
          <p className="text-sm text-center text-gray-500"> This is a commercial site designed for the solicitation of insurance from selected Auto insurance carriers. It is not an insurer, an insurance agency, or a auto insurance provider. Insurance agency services may be provided by a partner licensed agency. This site is not maintained by or affiliated with the federal government’s Auto Insurance Marketplace website or any state government Auto insurance marketplace</p>
          </div>
</section>
            </div>
        )
